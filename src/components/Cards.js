...
const styles = StyleSheet.create({
  ...
  threeActions: { minHeight: 64, flexDirection: 'row', gap: 12, paddingTop: 18, paddingHorizontal: 6 },
  twoActions: { minHeight: 64, flexDirection: 'row', gap: 12, paddingTop: 18, paddingHorizontal: 6 },
  ...
  briefFeatureBody: { flexDirection: 'row', gap: 18, alignItems: 'center', minHeight: 206 },
  briefFeatureText: { flex: 1, gap: 9, minWidth: 0, justifyContent: 'center', paddingRight: 2 },
  ...
  briefThumbWrap: { width: 162, flexShrink: 0, position: 'relative', minWidth: 0, marginLeft: 2 },
